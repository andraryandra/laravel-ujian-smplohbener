 ...
 <nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light bg-white border-bottom border-bottom-lg-0 border-end-lg" id="navbarVertical">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebarCollapse">
            <!-- Navigation -->
            <ul class="navbar-nav">
                <li class="nav-item"> <a class="nav-link" href="/dashboardAdmin"> <i class="bi bi-house"></i> Dashboard </a> </li>
                <li class="nav-item"> <a class="nav-link" href="/kategoriUjian"> <i class="bi bi-bar-chart"></i> Kategori Ujian </a> </li>
                <li class="nav-item"> <a class="nav-link" href="/soalUjian"> <i class="bi bi-chat"></i> Soal Ujian </a> </li>
                <li class="nav-item"> <a class="nav-link" href="#"> <i class="bi bi-bookmarks"></i> Nilai Ujian </a> </li>
